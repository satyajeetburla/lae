...
#     return np.concatenate([pos - self.goal[:3], vel, rot.flatten(), omega])
    return np.concatenate([self.dynamics.pos - self.goal[:3], self.dynamics.vel, self.dynamics.rot.flatten(), self.dynamics.omega])
...
def state_xyz_vxyz_R_omega_floor(self):
    ...
    return np.concatenate([self.dynamics.pos - self.goal[:3], self.dynamics.vel, self.dynamics.rot.flatten(), self.dynamics.omega, (self.dynamics.pos[2],)])
...
def state_xyz_vxyz_R_omega_wall(self):
    ...
    return np.concatenate([self.dynamics.pos - self.goal[:3], self.dynamics.vel, self.dynamics.rot.flatten(), self.dynamics.omega, wall_box_0, wall_box_1])
